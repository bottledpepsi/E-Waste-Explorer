  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-brand-blue/10 bg-background/90 backdrop-blur-md">
      <nav className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3 sm:px-6">
        <a
          href="#home"
          className="flex shrink-0 items-center gap-2 rounded-full bg-brand-blue px-3 py-1.5 font-display text-base font-extrabold text-white shadow-sm sm:text-lg"
        >
