    ...
    <section id="take-action" className="bg-brand-green-soft py-20 sm:py-24">
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        <Reveal className="mx-auto max-w-3xl text-center">
          <span className="mx-auto grid size-14 place-items-center rounded-2xl bg-brand-green text-white">
          ...
          <p className="mt-4 text-lg leading-relaxed text-pretty text-foreground/80 sm:text-xl">
            Small actions add up. Here is a practical e-waste action checklist.
          </p>
        </Reveal>
        ...
        <ul className="mt-12 grid gap-4">
          {ACTIONS.map((action, i) => (
            <Reveal as="li" key={i} delay={i * 70}>
              <div className="flex items-center gap-4 rounded-2xl border border-brand-green/20 bg-card p-5 shadow-sm transition-transform hover:translate-x-1">
