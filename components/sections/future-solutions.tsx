import { Lightbulb, RotateCcw, Recycle, Wrench } from 'lucide-react'
...
const CARDS = [
  ...
  },
  {
    ...
    text: 'Companies can design electronics to be easily taken apart and recycled from the very start. Materials get reused again and again, instead of being thrown away.',
  },
]
        ...
        <ol className="mt-12 grid gap-6 md:grid-cols-3">
          {CARDS.map(({ Icon, title, text }, i) => (
            <Reveal as="li" key={title} delay={i * 90}>
              <div className="flex h-full flex-col gap-4 rounded-3xl border border-brand-blue/10 bg-brand-blue-soft p-6 shadow-sm transition-transform hover:-translate-y-1">
