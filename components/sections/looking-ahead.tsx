...
const BAD = [
    ...
    'More pollution in soil, water and air.',
    'More valuable resources wasted.',
]
                                ...
                                {BAD.map((item) => (
                                    <li key={item} className="flex gap-3 text-base leading-relaxed text-white/85">
                                        <span aria-hidden="true"
                                              className="mt-2 size-2 shrink-0 rounded-full bg-brand-red"/>
                                        {item}
                                    </li>
                                ))}
                            </ul>
                  ...
                  <Sun className="size-6" aria-hidden="true"/>
                            ...
                            <ul className="mt-5 space-y-3">
                                {GOOD.map((item) => (
                                    <li key={item} className="flex gap-3 text-base leading-relaxed text-white/85">
                                        <span aria-hidden="true"
                                              className="mt-2 size-2 shrink-0 rounded-full bg-brand-green"/>
                                        {item}
                                    </li>
                                ))}
                            </ul>
