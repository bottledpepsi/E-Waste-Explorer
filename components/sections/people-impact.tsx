import {Coins, HeartPulse, Home} from 'lucide-react'
...
const CARDS = [
    {
        ...
        text: 'In some countries, people take apart e-waste by hand without safety gear. Breathing toxic smoke and touching chemicals can cause lung and skin problems.',
    },
    {
        Icon: Home,
        title: 'Communities',
    ...
    },
    {
        Icon: Coins,
        title: 'Wasted Money',
        text: 'Billions of dollars of useful materials are thrown away instead of being recycled.',
    },
]
                ...
                <ul className="mt-12 grid gap-6 md:grid-cols-3">
                    {CARDS.map(({Icon, title, text}, i) => (
                        <Reveal as="li" key={title} delay={i * 80}>
                            <div
                                className="flex h-full flex-col gap-4 rounded-3xl border border-brand-amber/20 bg-card p-6 shadow-sm transition-transform hover:-translate-y-1">
