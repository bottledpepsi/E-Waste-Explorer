            ...
            <div className="mx-auto max-w-5xl px-4 sm:px-6">
                <Reveal className="mx-auto max-w-3xl text-center">
                    ...
                    <p className="mt-4 text-lg leading-relaxed text-pretty text-foreground/80 sm:text-xl">
                        These are the totals made worldwide (in millions of tonnes).
                    </p>
                </Reveal>
                ...
                <Reveal className="mt-12">
                    <div
                        className="grid gap-5 rounded-3xl border border-brand-blue/10 bg-card p-6 shadow-sm sm:grid-cols-3 sm:p-8">
                        {TIMELINE.map(({year, value, note, projected}) => (
                            <div key={year} className="flex flex-col">
                                ...
                                <div className="mt-3">
                                    ...
                                    <span
                                        className={`ml-2 text-lg font-bold ${projected ? 'text-brand-amber' : 'text-brand-blue'}`}>
                                    {value} Mt
                                  </span>
                                </div>
                ...
                <Reveal className="mt-8">
                    <div
                        className="flex items-start gap-4 rounded-3xl border border-brand-red/20 bg-brand-amber-soft p-6">
            <span className="grid size-12 shrink-0 place-items-center rounded-2xl bg-brand-red text-white">
              <TrendingUp className="size-6" aria-hidden="true"/>
                        ...
                        <p className="text-base leading-relaxed font-semibold text-brand-navy sm:text-lg">
                            More people know e-waste and recycling schemes have grown,
