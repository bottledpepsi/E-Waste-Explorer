            ...
            <div className="mx-auto max-w-6xl px-4 sm:px-6">
                <Reveal className="mx-auto max-w-3xl text-center">
                    ...
                    <p className="mt-4 text-lg leading-relaxed text-pretty text-foreground/80 sm:text-xl">
                        E-waste is <strong className="text-brand-blue">any thrown-away device that has a plug or a
                        battery</strong>
                    </p>
                </Reveal>

                <ul className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-3 lg:grid-cols-7">
                    {ITEMS.map(({Icon, label}, i) => (
                        <Reveal as="li" key={label} delay={i * 60}>
                            <div
                                className="flex h-full flex-col items-center gap-1 rounded-3xl border border-brand-blue/10 bg-card p-6 text-center shadow-sm transition-transform hover:-translate-y-1">
                ...
                <span className="grid size-12 place-items-center rounded-2xl bg-brand-green text-white">
                  <Coins className="size-6" aria-hidden="true"/>
                                ...
                                <h3 className="font-display text-2xl font-extrabold text-brand-navy">Good stuff
                                    inside</h3>
                            </div>
                            <p className="mt-4 text-base leading-relaxed text-foreground/80">
                                Electronics are full of valuable materials we could reuse instead of
                ...
                <span className="grid size-12 place-items-center rounded-2xl bg-brand-red text-white">
                  <Skull className="size-6" aria-hidden="true"/>
                                ...
                                <h3 className="font-display text-2xl font-extrabold text-brand-navy">Bad stuff
                                    inside</h3>
                            </div>
                            <p className="mt-4 text-base leading-relaxed text-foreground/80">
                                Electronics also contain toxic materials that can harm people and nature
